...
public class EnergyShowView extends View {
    ...
    public EnergyShowView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public EnergyShowView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public EnergyShowView(Context context) {
        super(context);
        mCtx = context;
...
//                }
            ...
            for (int i = 0; i < 1; i++) {
                int x = Utils.randomNumber(width - 10);
                int y = Utils.randomNumber(height - 30);
