package com.example.mylibrary.loadingdialog.view;
...
import com.example.mylibrary.loadingdialog.manager.StyleManager;
...
public class LoadingDialog implements FinishDrawListener {
     ...
     * 上传文件
     */
    public void loadupLoadFailed() {
        mLoadingView.stopAnim();
        hideAll();
        mFailedView.setDrawDynamic(openFailedAnim);
        mFailedView.setVisibility(View.VISIBLE);
        loadingText.setText("上传文件失败!");
    }
